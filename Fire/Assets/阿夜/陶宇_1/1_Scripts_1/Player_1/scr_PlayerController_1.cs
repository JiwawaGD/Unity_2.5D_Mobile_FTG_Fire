...
public class scr_PlayerController_1 : MonoBehaviour
{
    #region - Variables -
    [SerializeField] [Header("角色資料")] scr_PlayerData_1 data;
    ...
    void Awake()
    {
        ...
        jump_btn = GameObject.Find("跳_btn_1").GetComponent<Button>();
        attack_btn = GameObject.Find("攻_btn_1").GetComponent<Button>();
    }
